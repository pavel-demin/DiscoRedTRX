...
//--------------------------------------------------------------
StringList_t *SGUI_StringListDelete(StringList_t *ptr, uint16_t cnt,
                                    uint16_t pos) {
  uint32_t n, m;
  StringList_t *dummy;
  StringList_t *ptr_new;
...
// Speicherbedarf (bytes) = 4 + MAX_STRINGLIST_LEN
//--------------------------------------------------------------
StringList_t *SGUI_StringListInsert(StringList_t *ptr, uint16_t cnt,
                                    uint16_t pos) {
  uint32_t n, m;
  StringList_t *dummy;
  StringList_t *ptr_new;
