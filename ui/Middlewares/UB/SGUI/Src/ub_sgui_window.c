...
SWINDOW_t *SGUI_WindowCreateMain(uint16_t window_nr) {
  ...
  if (SGUI_WINDOW.akt_anz >= (MAX_WINDOW_ANZ - 1))
    return NULL;
...
//--------------------------------------------------------------
SWINDOW_t *SGUI_WindowCreateChild(uint16_t window_nr, uint16_t x, uint16_t y,
  ...
  if ((w < 5) || (h < 5))
    return NULL;
  if ((x >= SGUI_SCREEN_MAXX) || (y >= SGUI_SCREEN_MAXY))
    return NULL;
  if ((x + w) > SGUI_SCREEN_MAXX)
    w = (SGUI_SCREEN_MAXX - x);
  if ((y + h) > SGUI_SCREEN_MAXY)
    h = (SGUI_SCREEN_MAXY - y);
...
void SGUI_WindowShow(uint16_t window_nr) {
  if (window_nr > 0) {
    ...
    SGUI_WINDOW.old_window = SGUI_WINDOW.aktiv_window;
    SGUI_ScreenDrawFullRect(0, 0, SGUI_SCREEN_MAXX, SGUI_SCREEN_MAXY,
                            SWINDOW_DEF_BACK_COL);
...
//--------------------------------------------------------------
uint16_t SGUI_WindowGetActivNr(void) { return SGUI_WINDOW.aktiv_window; }
...
void SGUI_WindowFormatInt(int32_t value, uint8_t digits, bool padding) {
  if (padding == false) {
    // ohne fuehrende null
    if (digits == 1)
      sprintf(SGUI_WINDOW.buf, "%1d", (int)(value));
    else if (digits == 2)
      sprintf(SGUI_WINDOW.buf, "%2d", (int)(value));
    else if (digits == 3)
      sprintf(SGUI_WINDOW.buf, "%3d", (int)(value));
    else if (digits == 4)
      sprintf(SGUI_WINDOW.buf, "%4d", (int)(value));
    else if (digits == 5)
      sprintf(SGUI_WINDOW.buf, "%5d", (int)(value));
    else if (digits == 6)
      sprintf(SGUI_WINDOW.buf, "%6d", (int)(value));
    else if (digits == 7)
      sprintf(SGUI_WINDOW.buf, "%7d", (int)(value));
    else if (digits == 8)
      sprintf(SGUI_WINDOW.buf, "%8d", (int)(value));
    else if (digits == 9)
      sprintf(SGUI_WINDOW.buf, "%9d", (int)(value));
    else if (digits == 10)
      sprintf(SGUI_WINDOW.buf, "%10d", (int)(value));
    else if (digits == 11)
      sprintf(SGUI_WINDOW.buf, "%11d", (int)(value));
    else if (digits == 12)
      sprintf(SGUI_WINDOW.buf, "%12d", (int)(value));
    else
      sprintf(SGUI_WINDOW.buf, "%d", (int)(value));
  } else {
    // mit fuehrender null
    if (digits == 1)
      sprintf(SGUI_WINDOW.buf, "%01d", (int)(value));
    else if (digits == 2)
      sprintf(SGUI_WINDOW.buf, "%02d", (int)(value));
    else if (digits == 3)
      sprintf(SGUI_WINDOW.buf, "%03d", (int)(value));
    else if (digits == 4)
      sprintf(SGUI_WINDOW.buf, "%04d", (int)(value));
    else if (digits == 5)
      sprintf(SGUI_WINDOW.buf, "%05d", (int)(value));
    else if (digits == 6)
      sprintf(SGUI_WINDOW.buf, "%06d", (int)(value));
    else if (digits == 7)
      sprintf(SGUI_WINDOW.buf, "%07d", (int)(value));
    else if (digits == 8)
      sprintf(SGUI_WINDOW.buf, "%08d", (int)(value));
    else if (digits == 9)
      sprintf(SGUI_WINDOW.buf, "%09d", (int)(value));
    else if (digits == 10)
      sprintf(SGUI_WINDOW.buf, "%010d", (int)(value));
    else if (digits == 11)
      sprintf(SGUI_WINDOW.buf, "%011d", (int)(value));
    else if (digits == 12)
      sprintf(SGUI_WINDOW.buf, "%012d", (int)(value));
    else
      sprintf(SGUI_WINDOW.buf, "%0d", (int)(value));
  }
}
...
void SGUI_WindowFormatFloat(float value, uint8_t digits, bool padding) {
  ...
  if (padding == false) {
    ...
    if (digits == 1)
      sprintf(SGUI_WINDOW.buf, "%1d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 2)
      sprintf(SGUI_WINDOW.buf, "%2d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 3)
      sprintf(SGUI_WINDOW.buf, "%3d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 4)
      sprintf(SGUI_WINDOW.buf, "%4d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 5)
      sprintf(SGUI_WINDOW.buf, "%5d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 6)
      sprintf(SGUI_WINDOW.buf, "%6d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 7)
      sprintf(SGUI_WINDOW.buf, "%7d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 8)
      sprintf(SGUI_WINDOW.buf, "%8d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 9)
      sprintf(SGUI_WINDOW.buf, "%9d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 10)
      sprintf(SGUI_WINDOW.buf, "%10d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 11)
      sprintf(SGUI_WINDOW.buf, "%11d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 12)
      sprintf(SGUI_WINDOW.buf, "%12d.%03d", (int)(vorkomma), (int)(nachkomma));
    else
      sprintf(SGUI_WINDOW.buf, "%d.%03d", (int)(vorkomma), (int)(nachkomma));
  } else {
    // mit fuehrender null (mit 3 Nachkommastellen)
    if (digits == 1)
      sprintf(SGUI_WINDOW.buf, "%01d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 2)
      sprintf(SGUI_WINDOW.buf, "%02d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 3)
      sprintf(SGUI_WINDOW.buf, "%03d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 4)
      sprintf(SGUI_WINDOW.buf, "%04d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 5)
      sprintf(SGUI_WINDOW.buf, "%05d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 6)
      sprintf(SGUI_WINDOW.buf, "%06d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 7)
      sprintf(SGUI_WINDOW.buf, "%07d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 8)
      sprintf(SGUI_WINDOW.buf, "%08d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 9)
      sprintf(SGUI_WINDOW.buf, "%09d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 10)
      sprintf(SGUI_WINDOW.buf, "%010d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 11)
      sprintf(SGUI_WINDOW.buf, "%011d.%03d", (int)(vorkomma), (int)(nachkomma));
    else if (digits == 12)
      sprintf(SGUI_WINDOW.buf, "%012d.%03d", (int)(vorkomma), (int)(nachkomma));
    else
      sprintf(SGUI_WINDOW.buf, "%0d.%03d", (int)(vorkomma), (int)(nachkomma));
  }
}
